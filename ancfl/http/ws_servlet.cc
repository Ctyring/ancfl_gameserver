...
int32_t FunctionWSServlet::onConnect(ancfl::http::HttpRequest::ptr header,
...
int32_t FunctionWSServlet::onClose(ancfl::http::HttpRequest::ptr header,
                                   ancfl::http::WSSession::ptr session) {
    if (m_onClose) {
...
int32_t FunctionWSServlet::handle(ancfl::http::HttpRequest::ptr header,
