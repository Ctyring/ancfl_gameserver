 ...
 * @brief Servlet封装
 */
#ifndef __ANCFL_HTTP_SERVLET_H__
#define __ANCFL_HTTP_SERVLET_H__
...
class Servlet {
   public:
    ...
    virtual int32_t handle(ancfl::http::HttpRequest::ptr request,
                           ...
                           ancfl::http::HttpSession::ptr session) = 0;
...
class FunctionServlet : public Servlet {
   public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t(ancfl::http::HttpRequest::ptr request,
                                  ancfl::http::HttpResponse::ptr response,
