...
int32_t FunctionServlet::handle(ancfl::http::HttpRequest::ptr request,
...
ServletDispatch::ServletDispatch() : Servlet("ServletDispatch") {
    m_default.reset(new NotFoundServlet("ancfl/1.0"));
}

int32_t ServletDispatch::handle(ancfl::http::HttpRequest::ptr request,
                                ancfl::http::HttpResponse::ptr response,
                                ancfl::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(ancfl::http::HttpRequest::ptr request,
                                ancfl::http::HttpResponse::ptr response,
                                ancfl::http::HttpSession::ptr session) {
    response->setStatus(ancfl::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "ancfl/1.0.0");
