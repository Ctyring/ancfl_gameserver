...
class WSServlet : public Servlet {
   public:
    ...
    virtual int32_t onConnect(ancfl::http::HttpRequest::ptr header,
                              ancfl::http::WSSession::ptr session) = 0;
    virtual int32_t onClose(ancfl::http::HttpRequest::ptr header,
                            ancfl::http::WSSession::ptr session) = 0;
    virtual int32_t handle(ancfl::http::HttpRequest::ptr header,
...
class FunctionWSServlet : public WSServlet {
   public:
    ...
    typedef std::function<int32_t(ancfl::http::HttpRequest::ptr header,
    ...
    virtual int32_t onConnect(ancfl::http::HttpRequest::ptr header,
                              ancfl::http::WSSession::ptr session) override;
    virtual int32_t onClose(ancfl::http::HttpRequest::ptr header,
                            ancfl::http::WSSession::ptr session) override;
    virtual int32_t handle(ancfl::http::HttpRequest::ptr header,
                           ancfl::http::WSFrameMessage::ptr msg,
