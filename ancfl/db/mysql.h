#ifndef __ANCFL_DB_MYSQL_H__
#define __ANCFL_DB_MYSQL_H__
...
class MySQL : public IDB, public std::enable_shared_from_this<MySQL> {
   ...
   public:
    ...
    ancfl::IStmt::ptr prepare(const std::string& sql) override;
...
typedef ancfl::Singleton<MySQLManager> MySQLMgr;
