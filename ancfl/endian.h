#pragma once
#define ANCFL_LITTLE_ENDIAN 1
#define ANCFL_BIG_ENDIAN 2
#include <byteswap.h>
#include <stdint.h>
#include <type_traits>
namespace ancfl {
...
#define ANCFL_BYTE_ORDER ANCFL_BIG_ENDIAN
#else
#define ANCFL_BYTE_ORDER ANCFL_LITTLE_ENDIAN
#endif

#if ANCFL_BYTE_ORDER == ANCFL_BIG_ENDIAN
template <class T>
