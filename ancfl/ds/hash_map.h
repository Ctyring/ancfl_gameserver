#ifndef __ANCFL_DS_HASH_MAP2_H__
#define __ANCFL_DS_HASH_MAP2_H__
...
class HashMap {
   public:
    ...
    void swap(HashMap& oth) {
        ancfl::RWMutex::WriteLock lock(m_mutex);
        ancfl::RWMutex::WriteLock lock2(oth.m_mutex);
...
ancfl::RWMutex HashMap<K, V, PosHash>::s_mutex[MAX_MUTEX];
