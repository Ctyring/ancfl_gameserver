#ifndef __ANCFL_ROCK_ROCK_STREAM_H__
#define __ANCFL_ROCK_ROCK_STREAM_H__

#include <boost/any.hpp>
#include "rock_protocol.h"
#include "ancfl/streams/async_socket_stream.h"
#include "ancfl/streams/load_balance.h"
...
class RockStream : public ancfl::AsyncSocketStream {
   public:
    typedef std::shared_ptr<RockStream> ptr;
    typedef std::function<bool(ancfl::RockRequest::ptr,
                               ancfl::RockResponse::ptr,
                               ancfl::RockStream::ptr)>
        request_handler;
    typedef std::function<bool(ancfl::RockNotify::ptr, ancfl::RockStream::ptr)>
        notify_handler;
   ...
   protected:
    ...
    void handleRequest(ancfl::RockRequest::ptr req);
    void handleNotify(ancfl::RockNotify::ptr nty);
...
class RockConnection : public RockStream {
   public:
    ...
    RockConnection();
    bool connect(ancfl::Address::ptr addr);
};
