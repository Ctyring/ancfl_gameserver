 ...
 * @brief Socket封装
 */
#ifndef __ANCFL_SOCKET_H__
#define __ANCFL_SOCKET_H__
...
class Socket : public std::enable_shared_from_this<Socket>, Noncopyable {
   public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(ancfl::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(ancfl::Address::ptr address);
...
class SSLSocket : public Socket {
   public:
    ...
    static SSLSocket::ptr CreateTCP(ancfl::Address::ptr address);
