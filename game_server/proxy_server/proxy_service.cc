...
bool ProxyService::ForwardToLogicServer(uint32_t client_conn_id,
                                        uint32_t msg_id,
...
bool ProxyService::ForwardToClient(uint32_t client_conn_id,
                                   uint32_t msg_id,
                                   const std::string& data) {
    // 转发消息到客户端
...
bool ProxyService::CreateSession(uint32_t conn_id,
                                 uint64_t account_id,
                                 uint64_t role_id,
