...
class SkillModule {
   public:
    ...
    bool GetSkillInfo(uint64_t role_id,
                      int32_t skill_config_id,
                      SkillInfo& info);
    ...
    // 技能使用
    bool UseSkill(uint64_t role_id,
                  int32_t skill_config_id,
                  uint64_t target_id,
                  float target_x,
                  float target_z);
    ...
    // 技能效果计算
    bool CalculateSkillDamage(uint64_t role_id,
                              int32_t skill_config_id,
                              uint64_t target_id,
                              int32_t& damage);
    bool CalculateSkillHeal(uint64_t role_id,
                            int32_t skill_config_id,
                            uint64_t target_id,
                            int32_t& heal);
    bool ApplySkillEffects(uint64_t role_id,
                           int32_t skill_config_id,
                           uint64_t target_id);

    // 技能目标选择
    bool GetSkillTargets(uint64_t role_id,
                         int32_t skill_config_id,
                         float target_x,
                         float target_z,
